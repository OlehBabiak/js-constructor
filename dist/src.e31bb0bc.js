...
exports.TextBlock = exports.ImageBlock = exports.ColumnsBlock = exports.TitleBlock = void 0;
...
var ColumnsBlock = /*#__PURE__*/function (_Block2) {
  ...
  _createClass(ColumnsBlock, [{
    key: "toHTML",
    value: function toHTML() {
      var html = this.value.map(
      /*`<div class="col-sm">${item}</div>`*/
      _utils.col).join(' '); // 	return `
      // 	<div class="row">
      // 	${html.join('')}
      // </div>
      // 	`
...
var TextBlock = /*#__PURE__*/function (_Block4) {
  ...
  return TextBlock;
}(Block); // Якщо ми захочемо додати новий блок, додаєм сюди новий клас, наслідуємся від Блок
...
var model = [new _blocks.TitleBlock('Конструктор сайтів на JS!!!!!', {
  styles: {
